...
import com.golong.bus.model.unionbank.postJson;
...
public class busController {
	    ...
	    public String upload(@RequestBody qrtrade trade) throws Exception {
	        ...
	        String strDate = formatter.format(new Date()); 
          	Common.writeLog("e:\\javaspace\\"+strDate+".log", jsonString);
	        ...
	        Common.writeLog("e:\\javaspace\\"+strDate+".log", "-----callback:"+rjsonString);
	        return rjsonString;
	    }
